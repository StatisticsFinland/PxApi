    ...
    public class TablesControllerTests
    {
        ...
        public async Task GetTablesAsync_TwoTables_ReturnsExpectedMetadata()
        {
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(pagedTableList.Tables[0].Table.Measures, Is.Not.Null);
                Assert.That(pagedTableList.Tables[0].Table.Measures, Has.Count.EqualTo(2));
                Assert.That(pagedTableList.Tables[0].Table.Measures[0].Name, Is.EqualTo("content-value0-name.en"));
                Assert.That(pagedTableList.Tables[0].Table.Measures[0].Unit, Is.EqualTo("content-value0-unit.en"));
                ...
                Assert.That(pagedTableList.Tables[0].Table.Classifications, Is.Not.Null);
                Assert.That(pagedTableList.Tables[0].Table.Classifications, Has.Count.EqualTo(2));
                Assert.That(pagedTableList.Tables[0].Table.Classifications[0].Name, Is.EqualTo("dim0-name.en"));
                Assert.That(pagedTableList.Tables[0].Table.Classifications[0].Size, Is.EqualTo(2));
