...
namespace PxApi.UnitTests.ControllerTests
{
    ...
    public class ErrorControllerTests
    {
        ...
        public void Error_WithInvalidModelException_ReturnsBadRequestWithCorrectMessageAndLogsInformation()
        {
            ...
            _mockLogger.Verify(
                x => x.Log(
                    ...
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Invalid model exception occurred.")),
                    exception,
        ...
        public void Error_WithJsonException_ReturnsBadRequestWithCorrectMessageAndLogsInformation()
        {
            ...
            _mockLogger.Verify(
                x => x.Log(
                    LogLevel.Information,
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Malformed JSON exception occurred.")),
                    exception,
                    It.IsAny<Func<It.IsAnyType, Exception?, string>>()),
                Times.Once);
        }
        ...
        public void Error_WithIOException_ReturnsInternalServerErrorWithCorrectMessageAndLogsCritical()
        {
            ...
            Assert.That(responseValue, Is.Not.Null);
            Assert.That(responseValue!.ToString(), Is.EqualTo("An error occurred while processing the request."));
            ...
            _mockLogger.Verify(
                x => x.Log(
                    LogLevel.Critical,
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("An IO error occurred.")),
                    exception,
                    It.IsAny<Func<It.IsAnyType, Exception?, string>>()),
                Times.Once);
        }
        ...
        {
            // Test null path scenario - controller should still return BadRequest
            ...
            // Test empty path scenario - controller should still return BadRequest
