    ...
    public class QueryFilterUtilsStructuredFiltersTest
    {
        ...
        public void ConvertFiltersArrayToFilters_WithMultipleFilters_ReturnsAllFilters()
        {
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(genderFilter.FilterStrings, Is.EqualTo(expected));
        ...
        private static readonly string[] expected0 = ["manufacturing", "services", "agriculture"];
        private static readonly string[] expected1 = ["Helsinki", "Tampere", "Turku"];
        private static readonly string[] expected2 = ["2020", "2021", "2022", "2023"];
        ...
        public void ConvertFiltersArrayToFilters_WithComplexValues_HandlesCorrectly()
        {
            ...
            using (Assert.EnterMultipleScope())
            {
                ...
                Assert.That(categoryFilter.FilterStrings, Is.EqualTo(expected0));
                
                CodeFilter regionFilter = (CodeFilter)result["region"];
                Assert.That(regionFilter.FilterStrings, Is.EqualTo(expected1));
